...
def create_new_conversation(title=None):
    ...
    try:
        ...
        print("Title:", title)
        print("New Conversation ID:", data.get("id"))
        print("Session state reset completed")
        print("==============================\n")
    ...
    try:
        ...
        for msg in conversation_data.get("messages", []):
            if msg.get("user_question"):
                ...
                print("Found user question:", last_user_question)
            ...
            if msg.get("sparql_query"):
                ...
                print("Found SPARQL query:", last_query)
        ...
        if last_user_question and last_query:
            ...
            print("\nFinal state:")
            print("Previous user input:", st.session_state["previous_user_input"])
            print("Previous query:", st.session_state["previous_query"])
